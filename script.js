const TRANSLATIONS = {
    ua: {
        ...
        sentences: [
            ...
            "Твій масаж — це святе (але і ти мені зробиш, почухаєш спинку?) 🖐️✨",
            "Я люблю тебе більше, ніж спати до обіду 🛌💖",
            "Обіцяю слухати твою музику, яку ти мені надсилаєш (а можна щось крім k-pop?) ❤️🎧",
    ...
    en: {
        ...
        sentences: [
            ...
            "Your massages are sacred (but you owe me one) 🖐️✨",
            "I love you more than sleeping until noon 🛌💖",
            "I promise to listen to your music that you send me (but can it be something other than k-pop?) ❤️🎧",
